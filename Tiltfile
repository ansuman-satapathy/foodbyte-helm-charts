...
k8s_yaml('../foodbyte-gitops/clusters/production/infrastructure/gateway-class.yaml')
k8s_yaml('../foodbyte-gitops/clusters/production/infrastructure/envoy-proxy-config.yaml')
k8s_yaml('../foodbyte-gitops/clusters/production/infrastructure/gateway.yaml')
